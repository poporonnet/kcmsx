...
describe('GenerateRankingService: 予選', () => {
  it.todo('ランキングを生成できる');
  it.todo('ランキングにはエントリーしたチームのみが含まれる');

  it.todo('同点のとき: 2回の走行のうちどちらか早い方の結果が早いチームを上位にする');

  it.todo('同点のとき: 2回の走行の結果が全て同じ場合は、同じ順位として扱う');
});

describe('GenerateRankingService: 本戦', () => {
  it.todo('ランキングを生成できる');
  it.todo('トーナメント開催途中でも生成できる');
  it.todo('ランキングには本戦出場したチームのみが含まれる');
