...
import { IconSquareMinusFilled, IconMinus, IconSquarePlus, IconPlus } from "@tabler/icons-react";
  ...
  return (
    <Group>
      ...
      <ActionIcon
        ...
        bg="white"
      >
        <IconSquareMinusFilled  style={{ width: "100%", height: "100%" }} />
      </ActionIcon>
      ...
      <ActionIcon
        ...
        bg="white"
      >
        <IconSquarePlus style={{ width: "100%", height: "100%" }} />
      </ActionIcon>
    </Group>
  );
};
